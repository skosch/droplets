...
Ashgriz} \email{\{skosch,ashgriz\}@mie.utoronto.ca} \affiliation{Department of
    ...
    \begin{abstract} Interferometric Laser Imaging for Droplet Sizing (ILIDS
        ...
        estimates of this ``center discrepancy'' distortion, the
        ...
        directly. This approach eliminates the need for camera calibration and
...
Imaging) is an optical droplet sizing method in which a spray is illuminated by
...
from the focal plane, each pair of glare points---being sources of coherent
...
image extents. FIG. \ref{fig:discrepancy}, adapted from \citet{Hardalupas10},
...
no longer align (FIG. \ref{fig:drop-calibration-off}), and the calibration
...
sidestep the center discrepancy effect in simultaneous focused/defocused imaging

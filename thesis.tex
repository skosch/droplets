\documentclass[11.5pt,oneside]{book}

\usepackage[toc,page]{appendix}
\usepackage{sectsty, titlesec}
\usepackage{setspace}
\usepackage{wrapfig, rotating, subcaption}
\usepackage{enumitem,tabularx, booktabs, longtable}
\usepackage{nomencl}
\makenomenclature
...
\setsansfont[Scale=1, Path=./]{din1451m.otf}
\setmonofont{Sauce Code Powerline}
...
while allowing me the room to work in my own way. Thank you for entrusting me, a Civil
Engineering major, with your research project---and for indulging all of my crazy ideas.
...
Finally I want to express my gratitude to my family and my best friend, QP, for
everything. I wouldn't have made it here without you guys.
\vfill
\tableofcontents
\listoftables
\listoffigures
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{papers/hdg_images/designpicture.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{papers/hdg_images/numbers.eps}
...
\appendix
\chapter{Appendix}
\addcontentsline{toc}{section}{Detecting overlapping disks using a circular
Hough transform}
...
\lstinputlisting{papers/houghscript.py}
\begin{figure}
    \centering
...
\addcontentsline{toc}{section}{Detection of stripes and ILIDS size analysis}
\section*{Detection of stripes and ILIDS size analysis}
\lstinputlisting{papers/stripdetect.py}

\addcontentsline{toc}{section}{Homography estimation using ASIFT}
\section*{Homography estimation using ASIFT}
\lstinputlisting{papers/asift.py}
The above script relies on \texttt{find\_obj.py}, which is part of the OpenCV
samples collection and reproduced below.
\lstinputlisting{papers/find_obj.py}

%\addcontentsline{toc}{section}{Reverse PDPA analysis}
%\section*{Reverse PDPA analysis}
%\lstinputlistings{}

\addcontentsline{toc}{section}{Sample set of raw PDPA data}
...
%\midrule
        \input{papers/125_coincident.csv}
        %\bottomrule
\end{longtable}
